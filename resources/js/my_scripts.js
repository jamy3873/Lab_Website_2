...
function loadPlayersPage(){
	...
	for(var i = 0; i < players.length; i++){
		string += "<a class='dropdown-item' href=# onclick=switchPlayers("+i+")>"+players[i].name+"</a>";
	}
...
function switchPlayers(playerNum){
	...
	document.getElementById("avg_p_yards").innerHTML = Math.floor(avg_p);
	document.getElementById("avg_r_yards").innerHTML = Math.floor(avg_r);
	document.getElementById("avg_rec_yards").innerHTML = Math.floor(avg_rec);
}
